...
This then offers a web page:  192.168.4.1
...
Note: here is where a GUEST_USER_TAG would let a guest get the appropriate information (guest_user, guest_password)
